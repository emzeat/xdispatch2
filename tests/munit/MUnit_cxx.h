...
#define MU_DESC_ASSERT_EQUAL_STR(D, A, B)                                      \
    __MU_DESC_ASSERT_EQUAL_STR(D, A, B, __FILE__, __LINE__)
inline void
__MU_DESC_ASSERT_EQUAL_STR(const std::string& D,
                           const std::string& A,
                           const std::string& B,
                           const char* file,
                           int line)
