...
public:
    ...
    */
    ...
    /**
        ...
        @param timeout give a time here or a DISPATCH_TIME_FOREVER to wait until all operations are done
    ...
    */
    ...
    /**
        ...
        queue once all operations associated with the dispatch igroup_impl have completed.

        If no operations are associated with the dispatch igroup_impl (i.e. the igroup_impl is empty)
        ...
        the target queue immediately. The igroup_impl may either be deleted
